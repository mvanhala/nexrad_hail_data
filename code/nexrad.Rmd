...
To begin, I downloaded the NEXRAD hail signatures [data](http://www1.ncdc.noaa.gov/pub/data/swdi/database-csv/v2/). These hail csv files were downloaded and extracted to the folder `data/nexrad/hail/csv`. Then the first step is reading all of the files.
